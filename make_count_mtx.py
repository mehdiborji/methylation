...
if methylation_context == 'Non_CpG_context':
    multipler_per_task = 1 # will run this many of batches in each task, could be one by one or many ar once using pool
else:
    multipler_per_task = 10
    
start = (parts_batch - 1) * multipler_per_task
end = parts_batch * multipler_per_task
