...
The MCDS files are generated by running the following script which wraps `allcools generate-dataset` function
```
sbatch  ~/methylation/scripts/allcools_mcds_generate.sh . sample
```
